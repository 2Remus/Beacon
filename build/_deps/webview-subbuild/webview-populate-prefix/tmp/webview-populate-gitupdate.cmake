...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "0.12.0"
  WORKING_DIRECTORY "/Users/adafaralph/dev/Beacon2.0/build/_deps/webview-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/adafaralph/dev/Beacon2.0/build/_deps/webview-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/adafaralph/dev/Beacon2.0/build/_deps/webview-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
